...
#####JOINT FILTERING
    ...
    system("ngsutilsj bam-filter --whitelist $pass_all $unique1 $finalbam1");
    system("ngsutilsj bam-filter --whitelist $pass_all $unique2 $finalbam2");
    system("ngsutilsj bam-filter --whitelist $pass_all $unique3 $finalbam3");
