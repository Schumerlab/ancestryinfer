...
my $hyb_string=""; my $par_string="";
	...
	print VARSCRIPT "perl $path/run_samtools_to_hmm_threegenomes_v1.pl $current_job $genome1 $genome2 $genome3 $read_length $save_files $max_align $focal_chrom $rec_M_per_bp $path $quality\n";
