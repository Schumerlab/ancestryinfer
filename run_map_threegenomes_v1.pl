...
if(@ARGV<5){
    print "perl run_map_v3.pl read1_list parent1_genome parent2_genome parent3_genome SE_or_PE\n";
}
...
open OUT3, ">sam_files_mapped_to_parent3";
while(my $line1 =<IN1>){
    ...
    my $sam3 = "$line1"."$name_tag".".par3.sam";
    ...
    system("bwa mem -M -R $RG1 $genome3 $line1 > $sam3");
